...
function onStartCountdown()
	if isStoryMode then
		if playDialogue then
			...
			makeAnimatedLuaSprite("cutscenesenben", "/cutscene/weekme/song1/me", 400, 350);
			addAnimationByPrefix("cutscenesenben", "song1a", "song1a0000",24,false);
			addAnimationByPrefix("cutscenesenben", "song1b", "song1a0001",24,false);
			doTweenX("x", "cutscenesenben.scale", 1.2, 1, "quardease");
			doTweenY("y", "cutscenesenben.scale", 1.2, 1, "quardease");
...
function onUpdate()
	if isStoryMode then
		if playDialogue then
			doTweenAlpha("healthBarBack", "healthBar", 1, 0.3, "")
...
function onTimerCompleted(tag)
	...
	if tag == "cutsceneTimer1" then
		...
		objectPlayAnimation('cutscenesenben','song1a',false);
		addLuaSprite("cutscenesenben");
	...
	if tag == "cutsceneTimer3" then
		...
		objectPlayAnimation('cutscenesenben','song1b',false);
	end
end
...
function onNextDialogue(count)
	...
	setProperty('cutscenesenben.visible', false);
end
function skip()
